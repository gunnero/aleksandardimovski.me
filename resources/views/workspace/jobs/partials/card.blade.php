<article class="opportunity-card">
    ...
    <div class="opportunity-summary">
        ...
        <dl class="data-list data-list--compact">
            ...
            @if($job->review_status === 'rejected')<x-workspace.field-row label="Rejection reason">{{ str($job->rejection_reason ?: 'Not specified')->replace('_',' ')->title() }}</x-workspace.field-row>@endif
