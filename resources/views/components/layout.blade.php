...
<head>
    ...
    @php
        $personSchema = ['@context' => 'https://schema.org', '@type' => 'Person', 'name' => 'Aleksandar Dimovski', 'url' => config('app.url'), 'jobTitle' => ['Senior PHP / Laravel Engineer', 'Backend & Product Engineer'], 'description' => 'Senior PHP / Laravel Engineer and Backend & Product Engineer with long-term PHP, SQL, Linux, and production-operations experience', 'email' => config('portfolio.email'), 'telephone' => config('portfolio.phone'), 'address' => ['@type' => 'PostalAddress', 'addressLocality' => 'Bitola', 'postalCode' => '7000', 'addressCountry' => 'MK'], 'sameAs' => [config('portfolio.github'), config('portfolio.linkedin_url')]];
